...
# the P0 that are going to be used
P0_scales = [0.05, 0.1, 0.25, 0.5, 0.75, 1]
...
for P0_scale in P0_scales:
    filename = "output_P0scale_%.1E.dat" % P0_scale
    command = "cd ../build && ./main.x %g %g %g %g %g %s setP &> /dev/null" % (R,M,P0_scale,T,dm,filename)
    print "\nRunning with args: %g %g %g %g %g %s setP" % (R,M,P0_scale,T,dm,filename)
    os.system(command)
...
for i, data in enumerate(allData):
    ...
    mfig.plot(r, m,
            label=(r'$P_0/P_{0,i}=%s$' % P0_scales[i]))
    Pfig.semilogy(r, P,
            label=(r'$P_0/P_{0,i}=%s$' % P0_scales[i]))
    Lfig.plot(r, L,
              label=(r'$P_0/P_{0,i}=%s$' % P0_scales[i]))
...
mfig.set_title(r'$m(r)$ for various initial pressures')
mfig.set_xlabel(r'$r/R_0$')
mfig.set_ylabel(r'$m/M_0$')

Pfig.set_title(r'$P(r)$ for various initial pressures')
Pfig.set_xlabel(r'$r/R_0$')
Pfig.set_ylabel(r'$P/P_0$')

Lfig.set_title(r'$L(r)$ for various initial pressures')
Lfig.set_xlabel(r'$r/R_0$')
Lfig.set_ylabel(r'$L/L_0$')

Tfig.set_title(r'$T(r)$ for various initial pressures')
Tfig.set_xlabel(r'$r/R_0$')
Tfig.set_ylabel(r'$T/T_0$')

rhofig.set_title(r'$\rho(r)$ for various initial pressures')
...
#ax[0].set_title(r'$m(r)$ for various initial pressures')
#ax[0].set_xlabel(r'$r/R_0$',size=20)
ax[0].set_ylabel(r'$m/M_0$',size=20)

#ax[1].set_title(r'$P(r)$ for various initial pressures')
#ax[1].set_xlabel(r'$r/R_0$',size=20)
ax[1].set_ylabel(r'$P/P_0$',size=20)

#ax[2].set_title(r'$L(r)$ for various initial pressures')
#ax[2].set_xlabel(r'$r/R_0$',size=20)
ax[2].set_ylabel(r'$L/L_0$',size=20)

#ax[3].set_title(r'$T(r)$ for various initial pressures')
ax[3].set_xlabel(r'$r/R_0$',size=20)
ax[3].set_ylabel(r'$T/T_0$',size=20)

#ax[4].set_title(r'$\rho(r)$ for various initial pressures')
...
# ax[0,0].set_title(r'Solutions for different starting initial pressures, $R_0$', size=18)
