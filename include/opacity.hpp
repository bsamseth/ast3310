 ...
 * significant increase in speed, compared to the alternative.
 */
class Opacity {
 public:
   ...
   * Extrapolating will be preformed if needed, where new points are taken
   * based on a linear gradient on the two closest data points, in each
