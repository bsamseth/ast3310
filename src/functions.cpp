...
namespace Lambdas {
  ...
  std::function<double(double)> lambda_pp = [](double T) {
    double T9 = T * 1e-9;
  ...
  std::function<double(double)> lambda_33 = [](double T) {
    double T9 = T * 1e-9;
  ...
  std::function<double(double)> lambda_34 = [](double T) {
    double T9 = T * 1e-9;
  ...
  std::function<double(double)> lambda_e7Be = [](double T) {
    double T9 = T * 1e-9;
  ...
  std::function<double(double)> zero = [](double x) {return 0.0;};


  std::function<double(double)> lambda [Particles::N_PARTICLES][Particles::N_PARTICLES] = {
